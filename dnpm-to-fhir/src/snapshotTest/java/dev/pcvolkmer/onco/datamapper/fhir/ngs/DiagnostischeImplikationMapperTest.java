...
class DiagnostischeImplikationMapperTest extends DnpmToFhirTest {

  @ParameterizedTest
  @ValueSource(strings = {"simplevariant.json"})
  void shouldMapDiagnostischeImplikation(String filename) throws IOException {
    var inputStream =
